...
import com.bprmaa.mobiles.Activity.LoginActivity;
...
public class PengajuanActivity extends AppCompatActivity{
    ...
    private void setupViewPager(ViewPager viewPager){
        ...
        adapter.addFragment(new PengajuanKreditFragment(), "kredit");
        adapter.addFragment(new PengajuanTabunganFragment(), "Tabungan/Deposito");
